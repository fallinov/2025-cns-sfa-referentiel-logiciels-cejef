...
const levels: Level[] = [
  {
    ...
    short: "Les élèves peuvent créer un compte et utiliser l'outil avec leurs vraies données.",
  ...
  },
  {
    ...
    short: "Pas de données d'élèves. Les élèves peuvent l'utiliser avec un compte anonyme (adresse e-mail alias).",
  ...
  },
  {
    ...
    icon: "i-lucide-x",
    label: "Interdit",
    short: "Ne respecte pas les exigences de protection des données. Usage interdit.",
