        ...
        <div class="mt-6 space-y-3">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-base text-gray-500 dark:text-gray-400">
                Logiciel recommandé et mis en avant par le service correspondant (SEN ou SFP), généralement financé par celui-ci. À utiliser en priorité parmi les alternatives disponibles.
              </p>
            </div>
          </div>
